...
public class RoundedUniforms {
    ...
    private static final DynamicUniformStorage<RoundedRectData> ROUNDED_STORAGE = new DynamicUniformStorage<RoundedRectData>("Catppuccin - Rounded UBO", ROUNDED_DATA_SIZE, 16);
